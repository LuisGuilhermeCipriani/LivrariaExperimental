...
public class FormVenda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btIncluir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/icIncluirItem.png"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(1156, 759));
    ...
    private void btBuscarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btBuscarItemActionPerformed
        ...
        livro = FormPrincipal.daoLivro.buscarLivro(Integer.parseInt(codigo));
        if(livro != null){
            String titulo = livro.getTitulo();
            lbTitulo.setText(titulo);
            String editora = livro.getFornecedor();
            lbEditora.setText(editora);
            float valor = livro.getValor();
    ...
    private void inserirTabela(Livro livro, Item item){
        modelo.addRow(new Object[]{livro.getCodigo(), livro.getTitulo(), item.getQuantidade(), livro.getValor(), 
        item.getValorItem()});
    }
