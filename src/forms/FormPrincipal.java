...
public class FormPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JMenuItemVender.setName("JMenuItemVender"); // NOI18N
        ...
        JMenuNotaFiscal.setText("Nota Fiscal");
        JMenuNotaFiscal.setName("JMenuNotaFiscal"); // NOI18N

        JMenuItemEmitirNotaFiscal.setText("Emitir Nota Fiscal");
        JMenuItemEmitirNotaFiscal.setName("JMenuItemEmitirNotaFiscal"); // NOI18N
        JMenuItemEmitirNotaFiscal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JMenuItemEmitirNotaFiscalActionPerformed(evt);
            }
        });
        JMenuNotaFiscal.add(JMenuItemEmitirNotaFiscal);

        jMenuBar1.add(JMenuNotaFiscal);
    ...
    private void JMenuItemEmitirNotaFiscalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JMenuItemEmitirNotaFiscalActionPerformed
        new FormEmissaoNotaFiscal().setVisible(true);
    }//GEN-LAST:event_JMenuItemEmitirNotaFiscalActionPerformed
